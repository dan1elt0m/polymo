...
For example, pointing the builder at `https://jsonplaceholder.typicode.com/posts` generates (trimmed for brevity — the real file also includes retry/backoff and pagination helpers):

```python
"""posts — generated by the polymo builder. Standalone script; polymo
is not needed at runtime."""

BASE_URL = "https://jsonplaceholder.typicode.com"
PATH = "/posts"

# ... fetch_records() handles requests, retries, and pagination ...
