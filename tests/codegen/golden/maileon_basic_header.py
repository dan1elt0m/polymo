"""Lakeflow Declarative Pipelines connector for contacts."""
...
OPT_API_KEY_B64: str = "REPLACE_ME"

BASE_URL: str = "https://api.maileon.com/1.0"
PATH: str = "/contacts"
PARAMS: dict[str, Any] = {}
HEADERS: dict[str, str] = {"Authorization": f"Basic {OPT_API_KEY_B64}", "Accept": "application/vnd.maileon.api+xml"}
TIMEOUT: float = 30.0
