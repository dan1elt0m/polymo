...
// Databricks integration response shapes (see
// src/polymo/ui/app.py for the source of truth).
...
export interface ConfigFormState {
  ...
  // Added pagination input fields used by the UI (not yet serialized to backend config)
