...
export const DeployPanel: React.FC = () => {
	...
	// the issue elsewhere in the form. Guarded so this doesn't force a
	// re-render on every keystroke across the whole form once the
	...
	const handleBootstrap = React.useCallback(async () => {
		...
		// Gate on the same client-side validation the rest of the form
